...
### Production DB (Azure PostgreSQL)

For production, point API/runner to Azure PostgreSQL Flexible Server:

- `DATABASE_URL=postgresql+asyncpg://...` (set as Container App secret)
