...
# 환경 변수로 설정 가능: CANDLE_INTERVAL (기본: 1m), LEVERAGE (기본: 10), MAX_POSITION (기본: 1.0), RSI_PERIOD (기본: 2), LOG_INTERVAL (기본: 0), STOPLOSS_COOLDOWN_CANDLES (기본: 50), STOP_LOSS_PCT (기본: 0.05)
