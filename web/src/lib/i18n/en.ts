const en = {
  ...
  dashboard: {
    ...
    newsFlowFilterHot: "Hot",
    newsFlowFilterRising: "Rising",
    newsFlowFilterBullish: "Bullish",
    newsFlowFilterBearish: "Bearish",
    newsFlowFilterImportant: "Important",
    ...
    newsFlowNotConfigured: "News is unavailable until CRYPTOPANIC_AUTH_TOKEN is set on the server.",
